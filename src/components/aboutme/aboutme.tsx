const people = [
    {
        ...
        imageUrl: "/yellow-backgound.png",
        gitHubUrl: 'https://github.com/nsrf',
        linkedinUrl: 'https://www.linkedin.com/in/nasserfarhat/',
    },
]

export default function AboutMe() {
    return (
        <div className=" bg-zinc-800 bg-opacity-80 py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 text-center lg:px-8">
                <div className="mx-auto max-w-2xl">
                    <h2 className="text-balance text-4xl font-semibold tracking-tight text-white sm:text-5xl">Me</h2>
                    ...
                    <p className="mt-3 text-lg/8 text-gray-300">
                ...
                >
                    {people.map((person) => (
                        <li key={person.name} className="justify-center rounded-2xl bg-zinc-800 px-8 py-10">
                            <img alt="" src="/yellow-backgrond.png" className="mx-auto size-48 rounded-full md:size-56" />
                            ...
                            <ul role="list" className="mt-6 flex justify-center gap-x-6">
                                ...
                                <li>
                                    <a href={person.linkedinUrl} className="text-gray-400 hover:text-gray-300">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" fill="currentColor" y="0px"
                                             className="size-5" viewBox="0 0 50 50">
                                            <path
